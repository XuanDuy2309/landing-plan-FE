...
import { DistrictProvider, ProvinceProvider } from "src/core/modules/location";
...
export const ListDistrict = observer(({id, onChange }: IProps) => {
    const provider = useMemo(() => {
        const provider = new DistrictProvider();
    ...
    return (
        <div id={'district'} className='flex flex-col w-full h-[290px] overflow-y-auto'>
