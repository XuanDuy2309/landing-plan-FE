...
import { ProvinceProvider } from "src/core/modules/location";

interface IProps {
    onChange?: (value) => void
}

export const ListProvince = observer(({ onChange }: IProps) => {
    const provider = useMemo(() => {
        const provider = new ProvinceProvider();
    ...
    return (
        <div id={'province'} className='flex flex-col w-full h-[290px] overflow-y-auto'>
