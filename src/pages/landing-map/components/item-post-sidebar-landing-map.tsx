...
export const ItemPostSidebarLandingMap = observer(({ item }: IProps) => {
    return (
        <div onClick={() => {
        ...
        }} className="flex flex-col cursor-pointer hover:bg-gray-100 rounded-[4px] overflow-hidden w-full h-[360px] shadow-[0_2px_4px_rgba(0,0,0,0.2),0_-1px_0px_rgba(0,0,0,0.02)] text-[14px] leading-[16px] text-gray-700">
            <img src={item.image_links[0]} alt="" className="h-[194px] w-full flex-none" />
            <div className='flex flex-col justify-between h-full p-2'>
                <div className='flex flex-col gap-1'>
                    ...
                    <span className='line-clamp-2'>Loại đất: <strong >{item.type_landing_name} ({item.type_landing_code})</strong></span>
